...
async def list_snitches_impl(params: ListSnitchesParams) -> dict[str, Any]:
    ...
    """
    try:
        snitches = await client.list_snitches(tags=params.tags)
        return {
            "success": True,
            "count": len(snitches),
            "snitches": snitches,
...
async def get_snitch_impl(params: GetSnitchParams) -> dict[str, Any]:
    ...
    """
    try:
        snitch = await client.get_snitch(params.token)
        return {
            "success": True,
            "snitch": snitch,
        }
...
async def check_in_impl(params: CheckInParams) -> dict[str, Any]:
    ...
    """
    try:
        result = await client.check_in(params.token, params.message)
        return {
            "success": True,
...
async def create_snitch_impl(params: CreateSnitchParams) -> dict[str, Any]:
    ...
    """
    try:
        snitch = await client.create_snitch(
            name=params.name,
...
async def pause_snitch_impl(params: PauseSnitchParams) -> dict[str, Any]:
    ...
    """
    try:
        snitch = await client.pause_snitch(params.token, params.until)
        return {
            "success": True,
...
async def unpause_snitch_impl(params: UnpauseSnitchParams) -> dict[str, Any]:
    ...
    """
    try:
        snitch = await client.unpause_snitch(params.token)
        return {
            "success": True,
...
async def update_snitch_impl(params: UpdateSnitchParams) -> dict[str, Any]:
    ...
    try:
        snitch = await client.update_snitch(
            token=params.token,
            name=params.name,
            interval=params.interval,
            notes=params.notes,
...
async def delete_snitch_impl(params: DeleteSnitchParams) -> dict[str, Any]:
    """Delete a snitch."""
    try:
        result = await client.delete_snitch(params.token)
        return {
            "success": True,
...
async def add_tags_impl(params: AddTagsParams) -> dict[str, Any]:
    ...
    try:
        snitch = await client.add_tags(params.token, params.tags)
        return {
            "success": True,
...
async def remove_tag_impl(params: RemoveTagParams) -> dict[str, Any]:
    ...
    try:
        snitch = await client.remove_tag(params.token, params.tag)
        return {
            "success": True,
